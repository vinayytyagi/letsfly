          ...
          {images.map((image, index) => (
            currentImage !== index && (
              <Image 
                ...
                width={200} 
                height={120} 
                className="rounded-lg cursor-pointer opacity-70 hover:opacity-100 transition-all duration-500 ease-in-out w-[200px] h-[120px] object-cover hover:outline-2 hover:outline-[#d5e880] hover:rounded-br-[90]" 
